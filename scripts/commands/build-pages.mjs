...
export async function buildPagesArtifact({
  ...
  await copyIntoArtifact("app/appearance.js", outputDir, "appearance.js");
  ...
  await copyIntoArtifact("app/assets/brand-logo-white.svg", outputDir, "assets/brand-logo-white.svg");

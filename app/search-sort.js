...
export function matchesFilters(photo, filters = {}) {
    return (textMatches(photo, filters.search ?? "") &&
...
export function compareRecommended(left, right, task = {}) {
    return (photoScore(right, task) - photoScore(left, task) ||
...
export function filterAndSortPhotos(photos, { filters = {}, sortMode = "recommended", task = {}, discoverHistorySize = 12, discoverWindowSize = 24, selectedPhotoIds = [], } = {}) {

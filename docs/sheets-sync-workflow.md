...
| 部署 Apps Script | 需要 `pnpm dlx @google/clasp` 可用且 Google 帳號有 script 權限 | `pnpm apps-script:push` 成功，且 Apps Script 專案顯示更新 | clasp 或 Google 帳號授權問題，不代表 repo schema 錯。 |
